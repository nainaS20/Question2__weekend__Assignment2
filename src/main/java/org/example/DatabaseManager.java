...
public class DatabaseManager {
    ...
    public static void top3Panels() {
        try (Connection connection = dataSource.getConnection();
            ...
            PdfGenerator.createPanelPdf(dataset,"C:\\Users\\naina.sharma\\Downloads\\SpringBootTutorial (1)\\QUESTION2__WEEKEND\\src\\main\\resources\\Top3Panel.pdf");
    ...
    public static void top3Skills() {
        try (Connection connection = dataSource.getConnection();
            ...
            PdfGenerator.createSkillsPdf(dataset,"C:\\Users\\naina.sharma\\Downloads\\SpringBootTutorial (1)\\QUESTION2__WEEKEND\\src\\main\\resources\\Top3Skills.pdf");
